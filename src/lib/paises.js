...
const MAPA = {
  ...
  /* Selecciones. La federación hace de "país" para que el modelo sepa
     de qué competición habla: hay eliminatorias homónimas en cada
     confederación y analizar la equivocada invalida todo. */
  'nations league': 'UEFA',
  'uefa nations league': 'UEFA',
  'concacaf nations league': 'Concacaf',
  'liga de naciones concacaf': 'Concacaf',
  'eliminatorias': 'FIFA',
  'eliminatorias mundial': 'FIFA',
  'eliminatorias uefa': 'UEFA',
  'eliminatorias conmebol': 'Conmebol',
  'eliminatorias concacaf': 'Concacaf',
  'eliminatorias caf': 'CAF',
  'eliminatorias afc': 'AFC',
  'clasificacion eurocopa': 'UEFA',
  'clasificación eurocopa': 'UEFA',
  'copa africana': 'CAF',
  'eliminatorias copa africana': 'CAF',
  'amistoso': 'FIFA',
  'amistosos': 'FIFA',
